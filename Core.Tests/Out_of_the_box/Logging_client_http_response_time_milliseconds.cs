...
namespace Core.Tests.Out_of_the_box
{
    public class Logging_client_http_response_time_milliseconds : Context
    {
        public Logging_client_http_response_time_milliseconds()
        {
